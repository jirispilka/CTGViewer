...
if __name__ == "__main__":
    ...
    dl = LoadData()
    adata = dl.read_data('/home/jirka/dokumenty/ensl/schifrin/data_sw_annotations/data/EHA0389_2007.mat')
    ndvi = adata['fhr']

    plt.plot ( ndvi, 'k-', label="MOD09 NDVI")
    ndvi_smooth = savitzky_golay(ndvi, window_size=251, order=3)
